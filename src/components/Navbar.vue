...
const handleThemeToggle = (e: Event) => {
  ...
  // 根据复选框是否选中，切换 dark/light 主题
  const newTheme = target.checked ? "dark" : "light";
  // 调用 switchMdTheme 修改 mdTheme 的值
  switchMdTheme(newTheme);
  console.log(mdTheme.value);
};
